...
const Index = () => {
 ...
 <WowInit /> 
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-10 text-center">
            <div className="p-6 rounded-2xl bg-background/50 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              ...
              <div className="text-muted-foreground text-lg font-semibold">{t("index.stats.yearsExperience")}</div>
            </div>
            <div className="p-6 rounded-2xl bg-background/50 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              <div className="text-5xl font-black text-primary mb-4">50+</div>
              <div className="text-muted-foreground text-lg font-semibold">{t("index.stats.employees")}</div>
            </div>
            <div className="p-6 rounded-2xl bg-background/50 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              <div className="text-5xl font-black text-primary mb-4">ISO</div>
              <div className="text-muted-foreground text-lg font-semibold">{t("index.stats.isoQuality")}</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* About ICTCO Section - Enhanced with better layout */}
      ...
      {/* Partners Section - Enhanced with better cards */}
      ...
      {/* Valued Clients Section - Enhanced grid */}
      <ClientsCarousel clients={clients} />
      
      {/* Additional Stats Section - Enhanced layout */}
      <section className="py-20">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            ...
            <div className="p-8 rounded-2xl bg-background shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
              <div className="text-4xl font-black text-primary mb-4">20+</div>
